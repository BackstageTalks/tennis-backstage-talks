...
def build_prediction_record(match, surface, elo_prediction, odds_data, form_store, mcp_stats):
    ...
    return {
        ...
        "odds_provider": odds_data.get("odds_provider"),
        "odds_event_id": odds_data.get("odds_event_id") or odds_data.get("event_id") or odds_data.get("match_id"),
        "no_odds_reason": None if pick_odds is not None else odds_data.get("no_odds_reason") or "no_odds_after_all_sources",
