# PREDICTION_CORE_VERSION = core_h2h_under_thinq_v1
...
def normalize_match(match):
    ...
    return {
        ...
        "player1Id": match.get("player1Id") or match.get("player1_id"),
        "player2_id": match.get("player2_id") or match.get("player2Id"),
        "player2Id": match.get("player2Id") or match.get("player2_id"),
        "tournament_id": match.get("tournament_id") or match.get("tournamentId"),
        "tournamentId": match.get("tournamentId") or match.get("tournament_id"),
        "unique_tournament_id": match.get("unique_tournament_id") or match.get("uniqueTournamentId"),
        "uniqueTournamentId": match.get("uniqueTournamentId") or match.get("unique_tournament_id"),
        "surface": match.get("surface"),
        "surface_raw": match.get("surface_raw"),
        "surface_source": match.get("surface_source"),
        "surface_model_bucket": match.get("surface_model_bucket"),
...
def build_prediction_record(
    ...
    # H2H is owned by THINQ. CORQ core must not call H2H directly.
    # Legacy h2h_* display fields are left empty here and populated via THINQ fields after attach.
    h2h_info = {}
