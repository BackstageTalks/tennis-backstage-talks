...
def infer_surface(surface_map, player1, player2, match):
    """Resolve match surface without poisoning missing values as Hard.

    Order:
    1. Tournament override, because some providers omit or mislabel surface.
    2. Explicit event/API surface, if present.
    3. Inferred surface_map.
    4. Unknown fallback, never automatic Hard.
    """
...
def build_prediction_record(
    ...
    return attach_thinq_to_prediction(
