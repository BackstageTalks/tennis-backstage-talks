...
def fetch_event_winning_odds_item(
    ...
    """
    Event-level PRO odds fallback chain.

    This is the critical coverage fix: do not stop after TennisApiDailyOdds.
    For events missing from the daily odds batch, try PRO event endpoints in
    this order before external fallback APIs are considered elsewhere:
