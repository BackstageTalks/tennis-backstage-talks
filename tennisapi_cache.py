...
def normalize_event_market_odds_payload(raw_odds: Any) -> Optional[Dict[str, Any]]:
    ...
    We only use the match winner market:
    - Full time
    - Home/Away
    - Match
    - choices name "1" and "2"
    """
    if not isinstance(raw_odds, dict):
        return None
    ...
    return {
        ...
        "odds_player1": odds1,
        "odds_player2": odds2,
        "home_fractional": choice1.get("fractionalValue") or choice1.get("initialFractionalValue"),
        "away_fractional": choice2.get("fractionalValue") or choice2.get("initialFractionalValue"),
