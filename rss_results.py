...
def opponent_odds_value(item):
    ...
    pick_name = normalized_name(pick)
    opponent_name = normalized_name(opponent)
    p1_name = normalized_name(p1)
    p2_name = normalized_name(p2)

    if opponent_name and p1_name and opponent_name == p1_name and odds1 is not None:
        return odds1
    if opponent_name and p2_name and opponent_name == p2_name and odds2 is not None:
        return odds2
    if pick_name and p1_name and pick_name == p1_name and odds2 is not None:
        return odds2
    if pick_name and p2_name and pick_name == p2_name and odds1 is not None:
        return odds1
    return None
