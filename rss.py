...
def latest_predictions():
    ...
    print("TOP prediction files found:", files)
    ...
    print("TOP RSS using prediction file:", path)
...
<title>Backstage Talks Tennis Picks</title>
<link>{BASE}</link>
<description>Daily tennis TOP picks with full details on pick pages</description>
{items}
</channel>
</rss>
"""
    ...
    print("TOP RSS GENERATED:", len(predictions), "items")
    print("TOP RSS PREVIEW:")
    print(rss[:2500])
