...
class ThinqService:
    ...
    def build_match_features(
        ...
        confidence = self._calculate_total_confidence(raw, edges, data_quality)
    ...
    def _calculate_total_confidence(self, raw: Dict[str, Any], edges: Dict[str, Optional[float]], data_quality: Dict[str, Any]) -> float:
        h2h = raw.get("h2h", {}) if isinstance(raw.get("h2h"), dict) else {}
        ...
        confidence = (0.55 * quality_score) + (0.15 * h2h_conf) + (0.30 * edge_coverage)
