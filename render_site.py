...
"""
        ...
        if most_likely_score:
            most_likely_html = f"""
        <div class="sets-row">
            <span class="sets-label">Score</span>
            <span class="sets-value">{most_likely_score}</span>
        </div>
"""
        ...
        <div class="intel-layout">
            <div class="sets-box">
                <div class="sets-row">
                    ...
                    <span class="sets-value">{expected_sets}</span>
                </div>

                <div class="sets-row">
                    <span class="sets-label">{sets_probability_label}</span>
                    <span class="sets-value">{sets_probability}</span>
                </div>
