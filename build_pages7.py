...
def mark_corq_view(prediction, corq_probability):
    ...
    updated["top_mode"] = "CORQ_THRESHOLD_55"
    updated["top_reason"] = "Corq AI probability >= 55%"
    return updated
...
def mark_thinq_view(prediction, thinq_probability, corq_probability):
    ...
    updated["corq_display_probability"] = corq_probability
    updated["top_mode"] = "THINQ_THRESHOLD_55"
    updated["top_reason"] = "Thinq AI probability >= 55%"
    return updated
...
def mark_blend_view(prediction, blend_probability, corq_probability, thinq_probability):
    ...
    updated["top_mode"] = "BLEND_50_50_THRESHOLD_55"
    updated["top_reason"] = "50% Corq AI + 50% Thinq AI; Blend probability >= 55%"
    return updated
...
def build_pages():
    ...
    write_page(
        ...
        title=SITE_TITLE,
        subtitle="Corq AI predictions >= 55%",
    ...
    write_page(
        ...
        title=SITE_TITLE,
        subtitle="Thinq AI predictions >= 55%",
    ...
    write_page(
        ...
        title=SITE_TITLE,
        subtitle="Blend 50/50 Corq and Thinq predictions >= 55%",
