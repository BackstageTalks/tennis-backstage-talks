...
def _find_in_legacy_odds_list(
    ...
    if reversed_order:
        p1 = matched.get("odds_player2") or matched.get("p2_odds") or matched.get("away_odds") or matched.get("odds2") or matched.get("price2")
        p2 = matched.get("odds_player1") or matched.get("p1_odds") or matched.get("home_odds") or matched.get("odds1") or matched.get("price1")
        matched["player1"] = player1
        matched["player2"] = player2
        matched["odds_player1"] = p1
        matched["odds_player2"] = p2
        matched["p1_odds"] = p1
        matched["p2_odds"] = p2
        matched["home_odds"] = p1
        matched["away_odds"] = p2
        matched["odds"] = p1
        matched["odds1"] = p1
        matched["odds2"] = p2
