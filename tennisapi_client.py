...
class TennisApiClient:
    ...
    Potvrdené endpointy podľa testov:
    - /api/tennis/category/{category_id}/events/{day}/{month}/{year}
    - getTennisMatchDetails cez match/event id
    - getMatchWinningOdds cez match/event id + provider id
    """
...
def fractional_to_decimal(value: Optional[str]) -> Optional[float]:
    ...
    Example: "73/100" -> 1.73, "11/10" -> 2.10
    """
