...
def mark_bst_view(prediction):
    ...
    # This is ONLY for the derived /BsT/ display object.
    # The source ALL/TOP snapshots are not changed.
    # render_site.py uses "probability" for the WIN % column, therefore on
    # /BsT/ we intentionally show BsT AI confidence as WIN %.
...
# Only difference: model confidence = bst_ai_probability.
# -----------------------------------------------------------------------------
